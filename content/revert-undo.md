...
_There is a difference between justice & revenge_
...
1. И короче, давай лучше им тред или канал создадим. Даже правки в правила внесем, типо: _срать разрешается, но при условии, что только ТАМ._
2. Назовем его как-нибудь, вроде: _версус быка и коровы_ :cow2: :ox:
